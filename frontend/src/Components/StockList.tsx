...
const StockList = ({ title, children }: StockListProps) => {
  return (
    <>
      ...
      <div className=" border-2 border-opacity-5 min-w-fit shadow-2xl  rounded-[25px] ">
        <table
          className={`  m-auto min-w-[90%] max-w-full overflow-hidden  border-separate  ${style.bg}`}
        >
